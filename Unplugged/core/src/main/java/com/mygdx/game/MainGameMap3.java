...
public class MainGameMap3 implements Screen {
    // game variables
    ...
    public void show() {
        ...
        TiledMap map = new TmxMapLoader().load("maps/mainMap3.tmx");
        ...
        all = new Texture("AnimationSheet_Character.png");
        reversedAll = new Texture("AnimationSheet_Character_Reversed.png");
        ...
        Texture still = new Texture("Microwave/still.png");
        robot = new MicrowaveRobot(world, still, 80, 70);
        Texture npcTex = new Texture("npc1.png");
        ...
        atlas = new TextureAtlas("menuTools.atlas");
        skin = new Skin(atlas);
        white = new BitmapFont(Gdx.files.internal("font/white.fnt"), false);
        black = new BitmapFont(Gdx.files.internal("font/black.fnt"), false);
        BitmapFont miniFont = new BitmapFont(Gdx.files.internal("font/miniFont.fnt"));
        ...
        TextureAtlas fieldAtlas = new TextureAtlas("settings_tools.atlas");
