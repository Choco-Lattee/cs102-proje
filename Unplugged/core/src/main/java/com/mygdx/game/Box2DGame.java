...
public class Box2DGame implements Screen {
    // game variables
    ...
    public void show() {
        ...
        gameData = GameData.loadPlayerPosition(game);
        ...
        robot = new MicrowaveRobot(world, still);
        ...
        pointPanel = new TextField("Point: 123", panelStyle);
        ...
        saveStage.setInputHandler(player.getPlayerPosition().x, player.getPlayerPosition().y);
            ...
            public boolean keyDown(int keycode) {
                switch (keycode) {
                    ...
                    case Keys.P:
                        ...
                        GameData.savePlayerPosition(player.getPlayerPosition().x, player.getPlayerPosition().y, game);
    ...
    public void render(float delta) {
        ...
        if (screenState == GAME_STATE) {
            ...
            if (player.getHeart() == 3) {
                ...
                threeHeartImage.setPosition(player.getX() + 115, player.getY() + 60);
            }
            if (player.getHeart() == 2) {
                gameStage.addActor(twoHeartImage);
                twoHeartImage.setSize(10, 5);
                twoHeartImage.setPosition(player.getX() + 120, player.getY() + 60);
            }

            if (player.getHeart() == 1) {
                gameStage.addActor(oneHeartImage);
                oneHeartImage.setSize(5, 5);
                oneHeartImage.setPosition(player.getX() + 125, player.getY() + 60);
            }
            gameStage.addActor(pointPanel);
            pointPanel.setSize(30, 30);
            pointPanel.setPosition(player.getX() + 80, player.getY() + 30);
            gameStage.act(delta);
            gameStage.draw();
