...
public class SubgameMenu implements Screen {
    ...
    public void show() {
        ...
        label = new Label("SELECT GAME", labelStyle);
        ...
        list.setItems(new String[] { "Stealth", "Light Puzzle Game", "Decetive Puzzle Game"});
